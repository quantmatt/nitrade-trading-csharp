...
namespace cTraderAPI
{
    public class Config
    {
        ...
        private void Init()
        {
            ClientId = "<Obtain from https://connect.spotware.com>";
            ClientSecret = "<Obtain from https://connect.spotware.com>";
            ApiHost = "demo.ctraderapi.com";
            ApiPort = 5035;
            PythonPath = "<Your python interpreter path>";  
        }
