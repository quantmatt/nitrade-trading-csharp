...
namespace cTraderAPI
{
    ...
    public delegate void TradeFailedHandler(long accountId, string message);
    ...
    public delegate void SymbolTickHandler(UserConfig user, long symbolId, bool isBid, ulong value, DateTime tickTime);
    ...
    public class MainController
    {
        ...
        public AccountAuthorisationComplete OnAccountAuthorised { get; set; }
        public TradeFailedHandler OnTradeFail { get; set; }
        public OrderAcceptedHandler OnOrderAccepted { get; set; }
        public OrderStopTargetAcceptedHandler OnStopTargetAccepted { get; set; }
        public OrderFilledHandler OnOrderFilled { get; set; }
        public OrderCanceledHandler OnOrderCancelled { get; set; }

        public bool ShouldWriteTicks { get; set; }
        ...
        public void GetSymbols(long ctraderAccountId)
        {
            ...
            while (!isShutdown)
            {
                ...
                if (collectedTicks.Count > 0)
                {
                    ...
                    foreach (Symbol symbol in config.Symbols)
                    {
                        ...
                        {
                            string path = Path.Combine("data_files", "price_data");
