...
namespace cTraderAPI
{
    public class UserConfig
    {
        ...
        private void Init()
        {
            Token = "<Obtain from https://connect.spotware.com/docs/open_api_2/getting_started_v2/open_authentication_v2 (NOTE: remove 'sandbox-' from the urls in the example>";
            RefreshToken = "";
            AccountId = 0; 
